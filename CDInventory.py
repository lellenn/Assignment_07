...
# Desc: Error Handling and Pickling
# Change Log: (Who, When, What)
# DBiesinger, 2030-Jan-01, Created File
# LWarner, 2021-Nov-27, Added Code for Error Handling and pickling
#------------------------------------------#
...
class FileProcessor:
    ...
    @staticmethod
    def write_file(file_name, table):  # this allows the data to be written to the .txt file
